...
public class Chapter1 {
    ...
    /// has a method show() to display the window the stage given by parameter in the start() method
    ...
    //// additional stages can be created using the Stage class constructor (Stage stage2 = new Stage();)
    ...
    /// Pane: container that can hold other nodes and arrange them in a specific layout
    //// is the base class for all layout panes
    /// Shape: text, rectange, line, circle, ellispe, polygon, polyline, arc, polygon
    /// UI Control: button, label, text field, check box, radio button, combo box, list view, table view, tree view, etc.
